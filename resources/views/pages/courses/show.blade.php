        ...
        <div class="flex flex-col gap-8 container pb-24">
            ...
            <div class="flex gap-6">
                <article class="flex flex-col gap-4">
                    <header class="text-lg font-semibold">Last Updated: {{ $course->updated_at->format('M d, Y') }}</header>
                    ...
                    <footer class="flex gap-2">
                        ...
                        <a href="https://github.com" class="text-center whitespace-nowrap rounded-md font-semibold px-4 py-2 bg-gray-100 hover:bg-gray-200 grow">Source Code</a>
                    </footer>
                </article>
                <div>lessons</div>
            </div>
