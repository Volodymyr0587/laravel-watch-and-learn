    ...
    <section class="pt-32 px-10">
        <div class="flex flex-col gap-8 container pb-24">
            ...
            <div class="flex flex-col gap-2">
                <iframe class="aspect-video rounded-md"
                    src="https://www.youtube.com/embed/hel0GmxeHyI?list=PLnKfPkeIekbb7X0TqmNNdX-CKOJaYNTpu"
                    title="{{ $lesson->title }}"
                ...
                <div class="flex gap-2">
                    ...
                    <a href="#" class="mr-auto rounded-md px-4 py-2 bg-gray-100 hover:bg-gray-200">
